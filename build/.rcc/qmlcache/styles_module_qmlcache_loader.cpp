...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_styles_module)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_styles_module))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_styles_module)() {
    return 1;
}
